...
import 'package:kalkulator_deposito/util/number_input_formater.dart';
        ...
        children: [
          ...
          Focus(
            onFocusChange: (isTrue) {
              _nominalFundCtrl.text = isTrue
                  ? data.resultData.nominalFund.toString()
                  : _nominalFundFormatter.format(
                      data.resultData.nominalFund.toString(),
                    );
            },
            child: TextFormField(
              ...
              inputFormatters: [
                ...
                // _nominalFundFormatter
              ],
              // onChanged: (val) {
              //   data.resultData = data.resultData.copywith(
              //     nominalFund: _nominalFundFormatter.getUnformattedValue(),
              //   );
          ...
          TextFormField(
            ...
            onChanged: (val) {
              data.resultData = data.resultData.copywith(
                interest: _interestFormatter.getUnformattedValue(),
              );
